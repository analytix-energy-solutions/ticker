  ...
  _renderPriorityFallbackBlock(c, escId) {
    ...
    return `
      <div class="form-group" style="margin-top:12px">
        ...
        <div style="font-size:12px;color:var(--secondary-text-color,#727272);margin-top:2px">
          Tries the primary group first for every notification in this category; falls back to everyone away only when the primary group is empty.
        </div>
      </div>
    `;
  },
